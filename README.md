...
- Explore data augmentation, Slicing Aided Hyper Inference (SAHI), Cross Validation
...
| 10. Improve Dataset                           | `auto_annotate.py` (re-run)   | Re-annotates data with the fine-tuned model to enhance annotations.                                      |
